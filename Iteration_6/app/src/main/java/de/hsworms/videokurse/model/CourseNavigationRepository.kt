...
@Singleton
class CourseNavigationRepository @Inject constructor(
    ...
    private suspend fun readCourseCatalog() {
        fileManager.downloadFileFromFirebase("", "course_catalog.json")
        val inputStream = fileManager.readLocalFile("", "course_catalog.json")
    ...
    private fun processVideoFiles(
        ...
        for (vf in videoFilesJsonArray) {
            ...
            val chapters = mutableListOf<VideoSection>()
    ...
    fun readCurrentCourseData(courseId: String) {
        ...
        val inputStream = fileManager.readFileFromAppResources(resId)
