...
@AndroidEntryPoint
class CourseListFragment @Inject constructor(): Fragment() {
    ...
    private inner class CourseAdapter(var videoListItems: List<CourseListItem>) :
        ...
        override fun onBindViewHolder(holder: CourseHolder, position: Int) {
            val videoCourse = videoListItems[position]
            val params = holder.itemView.layoutParams as RecyclerView.LayoutParams

            holder.itemView.layoutParams = params
            holder.bind(videoCourse)
        }
    }
